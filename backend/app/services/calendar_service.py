...
class CalendarService:
    def __init__(self):
        # Carichiamo il calendario reale dinamicamente da Jolpica
        api_races = ExternalApiService.get_calendar(year=2026)
        
        if api_races:
            self.races = api_races
        else:
            # Fallback se le API non rispondono
            self.races = [
            ...
            {"name": "Monaco Grand Prix", "country": "Monaco", "city": "Montecarlo", "circuit_name": "Circuit de Monaco", "lat": 43.7347, "lon": 7.4206, "date": date(2026, 6, 7), "round": 8},
            ...
            {"name": "Hungarian Grand Prix", "country": "Hungary", "city": "Budapest", "circuit_name": "Hungaroring", "lat": 47.5789, "lon": 19.2486, "date": date(2026, 8, 16), "round": 13},
            {"name": "Belgian Grand Prix", "country": "Belgium", "city": "Spa", "circuit_name": "Circuit de Spa-Francorchamps", "lat": 50.4372, "lon": 5.9714, "date": date(2026, 8, 30), "round": 14},
            {"name": "Dutch Grand Prix", "country": "Netherlands", "city": "Zandvoort", "circuit_name": "Circuit Zandvoort", "lat": 52.3888, "lon": 4.5409, "date": date(2026, 9, 6), "round": 15},
            {"name": "Italian Grand Prix", "country": "Italy", "city": "Monza", "circuit_name": "Autodromo Nazionale Monza", "lat": 45.6156, "lon": 9.2811, "date": date(2026, 9, 20), "round": 16},
            {"name": "Azerbaijan Grand Prix", "country": "Azerbaijan", "city": "Baku", "circuit_name": "Baku City Circuit", "lat": 40.3725, "lon": 49.8533, "date": date(2026, 10, 4), "round": 17},
            {"name": "Singapore Grand Prix", "country": "Singapore", "city": "Marina Bay", "circuit_name": "Marina Bay Street Circuit", "lat": 1.2914, "lon": 103.864, "date": date(2026, 10, 18), "round": 18},
            {"name": "United States Grand Prix", "country": "USA", "city": "Austin", "circuit_name": "Circuit of the Americas", "lat": 30.1328, "lon": -97.6411, "date": date(2026, 11, 1), "round": 19},
            {"name": "Mexico City Grand Prix", "country": "Mexico", "city": "Mexico City", "circuit_name": "Autódromo Hermanos Rodríguez", "lat": 19.4042, "lon": -99.0907, "date": date(2026, 11, 8), "round": 20},
            {"name": "São Paulo Grand Prix", "country": "Brazil", "city": "Interlagos", "circuit_name": "Autódromo José Carlos Pace", "lat": -23.7036, "lon": -46.6997, "date": date(2026, 11, 22), "round": 21},
            {"name": "Las Vegas Grand Prix", "country": "USA", "city": "Las Vegas", "circuit_name": "Las Vegas Strip Circuit", "lat": 36.1147, "lon": -115.173, "date": date(2026, 12, 5), "round": 22},
                {"name": "Qatar Grand Prix", "country": "Qatar", "city": "Lusail", "circuit_name": "Lusail International Circuit", "lat": 25.49, "lon": 51.4542, "date": date(2026, 12, 13), "round": 23},
                {"name": "Abu Dhabi Grand Prix", "country": "UAE", "city": "Yas Marina", "circuit_name": "Yas Marina Circuit", "lat": 24.4672, "lon": 54.6031, "date": date(2026, 12, 20), "round": 24},
            ]
